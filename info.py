...
API_ID = int(environ.get("API_ID", "27305049"))
API_HASH = environ.get("API_HASH", "0c27e5d25698e2c49da2b2dbdc8cb804")
BOT_TOKEN = environ.get("BOT_TOKEN", "8297345110:AAHuvw1bDTej58VAuZ_BckgTh5r5uAu80wk")
PORT = environ.get("PORT", "8082")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "7088510448").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "IM_OZIXCEO"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "https://t.me//OZIXCEO")  # ADMIN USERNAME
...
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003554468610"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", ""))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003675546710"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", ""))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", ""))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://ozixceo:Z9QwmJX9rYMxB356@cluster0.3m314nb.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "ozixceo")
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003356069467"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))8
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003554468610"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/OZIXSUPPORT")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+0fOafJRrGJYzZTZl")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://files.catbox.moe/8cnwvx.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://files.catbox.moe/jft0zb.jpg")
).split()
